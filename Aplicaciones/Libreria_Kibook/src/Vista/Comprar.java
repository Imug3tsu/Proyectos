...
public class Comprar extends javax.swing.JPanel {
    ...
    private void initComponents() {
        ...
        setBackground(new java.awt.Color(217, 232, 252));
        setToolTipText("");
        ...
        txtTitulo.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 2, 0, new java.awt.Color(153, 204, 255)));
        ...
        mostrarLibro.setBackground(new java.awt.Color(218, 220, 228));
        mostrarLibro.setBorder(javax.swing.BorderFactory.createMatteBorder(1, 1, 1, 1, new java.awt.Color(204, 204, 204)));
        mostrarLibro.setOpaque(true);
        add(mostrarLibro, new org.netbeans.lib.awtextra.AbsoluteConstraints(60, 250, 590, 300));

        label.setBackground(new java.awt.Color(233, 238, 252));
    ...
    private void btnComprarActionPerformed(java.awt.event.ActionEvent evt) {//GEN-FIRST:event_btnComprarActionPerformed
        ...
        ComprarLibroVentana com=new ComprarLibroVentana(null, true,datos);
        com.setVisible(true);
