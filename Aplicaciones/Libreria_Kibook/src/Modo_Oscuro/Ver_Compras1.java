...
public class Ver_Compras1 extends javax.swing.JPanel {
    ...
    private void crearDatos(){
        ...
        String autor=txtId.getText();
        String titulo=txtId.getText();
        String categoria=txtId.getText();
        double precio=Double.parseDouble(txtId.getText());
        int cantidad=Integer.parseInt(txtId.getText());
        int numPag=Integer.parseInt(txtId.getText());
        String fecha=txtId.getText();
        
        Object datos1[]={id,autor,titulo,categoria,precio,cantidad,numPag,fecha};
        modelo.addRow(datos1);*/
        //Object datos2[]={"546","pepe","libro 1","nada",100.99,2,23,"2022-02-10"};
