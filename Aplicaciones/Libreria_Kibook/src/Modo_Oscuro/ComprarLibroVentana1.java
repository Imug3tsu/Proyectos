...
public class ComprarLibroVentana1 extends javax.swing.JDialog {
    ...
    public ComprarLibroVentana1(java.awt.Frame parent, boolean modal,General datos) {
        this.datos=datos;
        initComponents();
    ...
    private void LibroComprado(){
        ...
        Ver_Compras libro=new Ver_Compras();
    }
    ...
    private void initComponents() {
        ...
        jPanel1.setBackground(new java.awt.Color(106, 107, 129));
        ...
        jLabel11.setBorder(javax.swing.BorderFactory.createMatteBorder(0, 0, 10, 0, new java.awt.Color(151, 154, 182)));
    ...
    public static void main(String args[]) {
        ...
        try {
            ...
            java.util.logging.Logger.getLogger(ComprarLibroVentana1.class.getName()).log(java.util.logging.Level.SEVERE, null, ex);
        ...
        java.awt.EventQueue.invokeLater(new Runnable() {
            public void run() {
                ComprarLibroVentana1 dialog = new ComprarLibroVentana1(new javax.swing.JFrame(), true,null);
